...
#==========================================
                        ...
                        if msg._from in "u6c69729c1a011e83329ada01f0b9d4ce":
...
#==========================================
                        ...
                        data = {
                            ...
                            "sentBy": {
                                ...
                                "linkUrl": "line://nv/profilePopup/mid=u6c69729c1a011e83329ada01f0b9d4ce"
                            }
                        }
                        sendTemplate(to, data)
#==========================================
                                ...
                                "contents": [
                                     {
                                        ...
                                        "body": {
                                            ...
                                            "action": {
                                                "type": "uri",
                                                "uri": "line://nv/profilePopup/mid=u6c69729c1a011e83329ada01f0b9d4ce",
                                                },
                                            "contents": [
                                                {
                                                    "type": "text",
...
#==========================================
                    if cmd == "chat maker":
                        ...
                        contact = khie.getContact(sender)
                        owner = "u6c69729c1a011e83329ada01f0b9d4ce"
                        mat_ = "Sender: @!"
                        mat_ += "\nMessage: {}".format(txt)
                        mat = {
...
#==========================================
                        ...
                        try:
                            ...
                            khietag = "u6c69729c1a011e83329ada01f0b9d4ce"
...
#==========================================
                       ...
                       if msg._from in "u6c69729c1a011e83329ada01f0b9d4ce":
                        ...
                        start = time.time()
                        khie.sendMessage("u6c69729c1a011e83329ada01f0b9d4ce", '</>')
